...
var DemoEng = angular.module('DemoEng');
DemoEng.service('Util', function($filter) {
...
DemoEng.service('BSServiceUtil', function(notify, ExportService, BSService, Cache) {
...
DemoEng.service('EmailService', function(notify, BSService) {
...
DemoEng.service('CommentService', function(notify, BSService) {
...
DemoEng.factory('ExportService', function($resource) {
...
DemoEng.factory('BSService', function($resource) {
...
DemoEng.service('AlertService', function(SweetAlert,notify) {
...
DemoEng.service('AppService', function(notify, BSServiceUtil, AlertService, Cache) {
...
DemoEng.service('Cache', function() {
    var map;
